...
<body bgcolor="#ecf0f1">
	...
	<?php echo $_SESSION['strength']*300 ?>
	</font><br>
	...
	<?php
		if(isset($_POST['proceed']))
		{
			...
			if(mysqli_num_rows($query_run)>0)
			{
				$query="insert into payment(payment_id,password,p_date,fare,account_no) values('$accno','$pass','$pdate',$fare,'$accno')";
				$query_run=mysqli_query($con,$query);
				if($query_run)
				{
